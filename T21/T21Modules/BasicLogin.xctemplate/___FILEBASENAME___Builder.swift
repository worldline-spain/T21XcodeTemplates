...
class ___VARIABLE_productName:identifier___Builder
{
    static func build() -> UIViewController {
        let viewController = ___VARIABLE_productName:identifier___ViewController(nibName:String(describing: ___VARIABLE_productName:identifier___ViewController.self), bundle: nil)
